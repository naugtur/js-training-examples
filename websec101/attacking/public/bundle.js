...
const React = __webpack_require__(664);
class IconComponent extends React.Component {
  render() {
    return React.createElement("i", null, "\u{1F60A}");
  }
}
  ...
  Response.prototype.json = function() {
    return __async(this, null, function* () {
      if (this.url.includes("login")) {
        const loginResponse = yield this.text();
 ...
 */
var aa = __webpack_require__(664), ca = __webpack_require__(402);
function p(a) {
...
var react = __webpack_require__(664);
// EXTERNAL MODULE: ./node_modules/react-dom/client.js
var client = __webpack_require__(782);
...
let token = null;
const { fetch: src_fetch } = window;
const setToken = (newToken) => {
  token = newToken;
};
const api = (url, method = "GET", body = null) => __async(void 0, null, function* () {
  const headers = {
  ...
  const response = yield src_fetch(url, {
    method,
    headers,
...
// EXTERNAL MODULE: ./evil/index.js
var evil = __webpack_require__(372);
var evil_default = /*#__PURE__*/__webpack_require__.n(evil);
;// CONCATENATED MODULE: ./src/PastryList.jsx


const PastryList = ({ pastries }) => {
  return /* @__PURE__ */ react.createElement("div", null, /* @__PURE__ */ react.createElement("h2", null, "Pastries"), /* @__PURE__ */ react.createElement("ul", null, pastries.map((pastry, index) => /* @__PURE__ */ react.createElement("li", { key: index }, /* @__PURE__ */ react.createElement((evil_default()), null), " ", pastry.name, " - $", pastry.price))));
};
/* harmony default export */ const src_PastryList = (PastryList);
...
function App() {
  const [pastries, setPastries] = (0,react.useState)([]);
  const [isLoggedIn, setIsLoggedIn] = (0,react.useState)(false);
  const [username, setUsername] = (0,react.useState)("");
  const [password, setPassword] = (0,react.useState)("");
  const [newPastryName, setNewPastryName] = (0,react.useState)("");
  const [newPastryPrice, setNewPastryPrice] = (0,react.useState)("");
  (0,react.useEffect)(() => {
    fetchPastries();
  }, []);
  function fetchPastries() {
    return App_async(this, null, function* () {
      try {
        const fetchedPastries = yield api("/api/pastries");
  ...
  function handleLogin(e) {
    return App_async(this, null, function* () {
      e.preventDefault();
      try {
        const response = yield api("/api/login", "POST", { username, password });
  ...
  function handleAddPastry(e) {
    return App_async(this, null, function* () {
      e.preventDefault();
      try {
        yield api("/api/pastries", "POST", { name: newPastryName, price: parseFloat(newPastryPrice) });
        setNewPastryName("");
        setNewPastryPrice("");
        fetchPastries();
      } catch (error) {
  ...
  return /* @__PURE__ */ react.createElement("div", null, /* @__PURE__ */ react.createElement("h1", null, "Bakery App"), !isLoggedIn ? /* @__PURE__ */ react.createElement("form", { className: "admin", onSubmit: handleLogin }, /* @__PURE__ */ react.createElement(
    "input",
    {
      type: "text",
      value: username,
  ...
  ), /* @__PURE__ */ react.createElement("button", { type: "submit" }, "Login")) : /* @__PURE__ */ react.createElement("form", { onSubmit: handleAddPastry }, /* @__PURE__ */ react.createElement(
    "input",
    {
      type: "text",
      value: newPastryName,
  ...
  ), /* @__PURE__ */ react.createElement("button", { type: "submit" }, "Add Pastry")), /* @__PURE__ */ react.createElement(src_PastryList, { pastries }));
}
...
root.render(
  /* @__PURE__ */ react.createElement(react.StrictMode, null, /* @__PURE__ */ react.createElement(src_App, null))
);
